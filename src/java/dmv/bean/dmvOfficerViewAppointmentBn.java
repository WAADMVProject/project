 ...
 * @author SAMIPC
 */
@Named("dmvOfficerAppointmentsBn")
@SessionScoped
public class dmvOfficerViewAppointmentBn implements Serializable {
...
//    private appointmentService appointmentService;
    ...
    public dmvOfficerViewAppointmentBn() throws SQLException {
...
//        c
    ...
    public void retrieveAllAppointments() {
        datetimes.clear();       
        appointments = ejbAppointmentFacade.getAllAppointments();
