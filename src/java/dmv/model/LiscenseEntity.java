 ...
 */
@Entity
public class LiscenseEntity implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LiscenseEntity)) {
            return false;
        }
        LiscenseEntity other = (LiscenseEntity) object;
    ...
    public String toString() {
        return "dmv.model.LiscenseEntity[ id=" + id + " ]";
    }
